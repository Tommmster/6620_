...
color sobre el que se encuentre, pinta la celda utilizando el siguiente color de la paleta \footnote{El primer color a utilizar es el segundo color de la paleta} y se mueve a la celda que tiene adelante. 
